              ...
              <div class="panel-body">
                <div class="row">
                    <div class="col-lg-12">
                      ...
                      <?php echo $this->Form->create('SubCategory',array('controller'=>'sub_categories','action'=>'add','type' => 'file')); ?>
                      ...
                      <div class="form-group">
                        ...
                        <?php echo $this->Form->input('category',array('required' =>'required','div'=>false,'label'=>false,'class'=>'form-control','options'=>$cat_list)); ?>
                      </div>
                      <div class="form-group">
                        <label>Order</label>
                      ...
                      <div class="form-group">
                        <label>Table name (example: article_xx)</label>
                        <?php echo $this->Form->input('app_table_name',array('required' =>'required','div'=>false,'label'=>false,'class'=>'form-control')); ?>
                      </div>
                      <div class="form-group">
                        <label for="subcat">Active</label>
                        <?php echo $this->Form->input('app_active',array('required' =>'required','div'=>false,'label'=>false,'id'=>'subcat')); ?>
                      </div>
